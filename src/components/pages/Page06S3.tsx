...
const Page06S3 = () => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="min-h-screen py-20 bg-gradient-to-br from-background via-background to-orange-500/10"
    >
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gradient-orange">S3 (Simple Storage Service)</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="h-full bg-gradient-card hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-300 border-orange-500/30">
        ...
        >
          <Dialog>
            <DialogTrigger asChild>
              <Button size="lg" className="text-lg px-8 py-4 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-500/80 hover:to-red-500/80">
                S3 자세히 알아보기
              </Button>
            </DialogTrigger>
