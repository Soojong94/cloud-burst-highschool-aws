...
const Page15Analytics = () => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="min-h-screen py-8 md:py-12 lg:py-0 flex items-center justify-center bg-gradient-to-br from-background via-slate-900 to-red-900/30 bg-tech-pattern relative overflow-hidden"
    >
      {/* 배경 요소들 */}
