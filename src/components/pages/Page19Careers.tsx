  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">AWS 관련 직업</h2>
            ...
            >
              <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                <CardHeader className="text-center">
                  <career.icon className="w-12 h-12 mx-auto text-primary mb-4" />
        ...
        >
          <Dialog>
            ...
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="text-2xl">AWS 커리어 완전 가이드</DialogTitle>
              </DialogHeader>
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-3">학습 경로</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">실무 경험</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">지속적 학습</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
