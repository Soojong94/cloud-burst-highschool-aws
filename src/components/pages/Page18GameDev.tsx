...
const Page18GameDev = () => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="min-h-screen py-20 bg-gradient-to-br from-background via-background to-red-500/10"
    >
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gradient-orange">게임 개발</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="h-full bg-gradient-card hover:shadow-lg hover:shadow-red-500/20 transition-all duration-300 border-red-500/30">
        ...
        >
          <Dialog>
            <DialogTrigger asChild>
              <Button size="lg" className="text-lg px-8 py-4 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-500/80 hover:to-pink-500/80">
                게임 개발 아키텍처
              </Button>
            </DialogTrigger>
