...
const Page02CloudIntro = () => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="min-h-screen py-20 bg-gradient-to-br from-background to-secondary/20"
    >
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gradient-green">클라우드 컴퓨팅이란?</h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 bg-gradient-to-r from-muted/50 to-primary/10 p-8 rounded-lg border border-primary/20"
        >
          <h3 className="text-2xl font-bold mb-4 text-center text-gradient-orange">클라우드의 3가지 서비스 모델</h3>
