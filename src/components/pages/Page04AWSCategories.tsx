...
const Page04AWSCategories = () => {
  ...
  return (
    <motion.section
      ...
      className="min-h-screen py-8 md:py-12 lg:py-0 flex items-center justify-center bg-gradient-to-br from-background via-slate-900 to-cyan-900/30 bg-pattern-grid relative overflow-hidden"
    >
      {/* 배경 요소들 */}
