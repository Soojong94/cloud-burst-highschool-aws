...
const Page17MobileDetail = () => {
  ...
  return (
    <motion.section
      ...
      className="h-screen flex items-center justify-center bg-gradient-to-br from-background via-slate-900 to-pink-900/30 bg-pattern-diagonal relative overflow-hidden"
    >
      {/* 배경 요소들 */}
