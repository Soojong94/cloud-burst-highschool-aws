        ...
        >
          <Dialog>
            ...
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto bg-gradient-to-br from-card to-background border-primary/30">
              <DialogHeader>
                <DialogTitle className="text-2xl text-gradient-green">AWS AI/ML 완전 가이드</DialogTitle>
              </DialogHeader>
              <div className="space-y-6">
                <div className="p-4 bg-blue-900/20 rounded-xl border border-blue-500/30">
                  <h3 className="text-xl font-semibold mb-3 text-blue-400">Amazon SageMaker</h3>
                ...
                <div className="p-4 bg-green-900/20 rounded-xl border border-green-500/30">
                  <h3 className="text-xl font-semibold mb-3 text-green-400">컴퓨터 비전 서비스</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="p-4 bg-purple-900/20 rounded-xl border border-purple-500/30">
                  <h3 className="text-xl font-semibold mb-3 text-purple-400">자연어 처리</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="p-4 bg-cyan-900/20 rounded-xl border border-cyan-500/30">
                  <h3 className="text-xl font-semibold mb-3 text-cyan-400">Amazon Bedrock</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="p-4 bg-orange-900/20 rounded-xl border border-orange-500/30">
                  <h3 className="text-xl font-semibold mb-3 text-orange-400">Amazon Q</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="p-4 bg-pink-900/20 rounded-xl border border-pink-500/30">
                  <h3 className="text-xl font-semibold mb-3 text-pink-400">AI/ML 활용 사례</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
