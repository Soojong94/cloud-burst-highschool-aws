  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">EC2 (Elastic Compute Cloud)</h2>
        ...
        >
          <Dialog>
            ...
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="text-2xl">EC2 완전 가이드</DialogTitle>
              </DialogHeader>
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-3">인스턴스 유형</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">요금 모델</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">보안 기능</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
